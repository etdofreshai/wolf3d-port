...
- `wl_schedule_describe_sound_channel_progress_window_from_chunk()` combines schedule arbitration with the progress-window descriptor, reporting accepted sound status plus its first bounded emission window while preserving held higher-priority channels.
