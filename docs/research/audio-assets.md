...
- `wl_advance_adlib_playback_cursor()` advances an AdLib sample index by a frame/sample delta, matching the PC speaker cursor contract for future shared mixer scheduling.
