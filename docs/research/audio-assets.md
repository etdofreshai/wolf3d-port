...
- Representative chunks:
  ...
  - chunk 87: 41 bytes, FNV-1a `0x799f60b1`; AdLib sample count 8, priority 1, instrument first/last bytes `0x70`/`0x03`, sample first/last bytes `0x04`/`0x2e`, trailing bytes 11.
  - chunk 174: 0 bytes.
