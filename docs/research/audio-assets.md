...
- Representative chunks:
  ...
  - chunk 174: 0 bytes.
  - chunk 261: 7,546 bytes, FNV-1a `0xea0d69d8`; IMF declared bytes 7,456, command count 1,864, first command `(reg=0, value=0, delay=189)`, last command `(reg=0, value=0, delay=1)`, max delay 64,098, zero-delay commands 0, total delay 25,697,407, trailing bytes 86.
