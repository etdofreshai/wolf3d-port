...
typedef struct wl_actor_spawn_delta_summary {
    size_t at_spawn_count;
    size_t moved_cardinal_count;
    size_t moved_diagonal_count;
    size_t invalid_spawn_position_count;
    size_t invalid_current_position_count;
    uint16_t farthest_moved_actor_index;
...
typedef struct wl_actor_attack_readiness_summary {
    ...
    size_t ready_horizontal_sight_count;
    size_t ready_vertical_sight_count;
...
typedef struct wl_runtime_tile_quadrant_summary {
    size_t northwest_solid_wall_count;
    size_t northeast_solid_wall_count;
    size_t southwest_solid_wall_count;
    size_t southeast_solid_wall_count;
    size_t northwest_open_count;
    size_t northeast_open_count;
    size_t southwest_open_count;
...
typedef struct wl_runtime_tile_diagonal_summary {
...
} wl_runtime_player_tile_neighborhood_summary;

typedef struct wl_runtime_player_cardinal_tiles_summary {
    size_t sampled_tile_count;
    size_t clear_floor_count;
    size_t solid_wall_count;
    size_t door_marker_count;
    ...
    uint16_t south_tile;
    uint16_t west_tile;
    uint8_t has_north_tile;
    uint8_t has_east_tile;
    uint8_t has_south_tile;
    uint8_t has_west_tile;
} wl_runtime_player_cardinal_tiles_summary;

typedef struct wl_runtime_player_facing_tile_summary {
...
typedef struct wl_runtime_player_facing_static_summary {
    wl_direction direction;
    size_t static_count_ahead;
    size_t blocking_count_ahead;
    size_t bonus_count_ahead;
    size_t inactive_count;
    size_t blocked_static_count;
    size_t invalid_static_position_count;
    uint16_t first_static_index;
    uint16_t first_static_distance;
...
typedef struct wl_runtime_player_interaction_summary {
    ...
    uint16_t nearest_tile_x;
    uint16_t nearest_tile_y;
...
int wl_summarize_path_marker_endpoints(
    const wl_game_model *model, wl_path_marker_endpoint_summary *out);
