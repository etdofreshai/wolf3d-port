...
typedef struct wl_sound_channel_schedule_tick_result {
...
typedef struct wl_sound_channel_progress {
    size_t sound_index;
    uint16_t priority;
    wl_audio_chunk_kind kind;
    size_t sample_position;
...
typedef struct wl_sound_channel_progress_window {
    wl_sound_channel_progress progress;
    wl_sample_playback_window window;
} wl_sound_channel_progress_window;

typedef struct wl_sound_channel_schedule_progress_window_result {
    wl_sound_channel_schedule_result schedule;
    wl_sound_channel_progress_window progress_window;
    uint8_t described;
} wl_sound_channel_schedule_progress_window_result;

typedef struct wl_sound_channel_schedule_tick_progress_window_result {
    wl_sound_channel_schedule_tick_result tick;
    wl_sound_channel_progress_window progress_window;
    uint8_t described;
} wl_sound_channel_schedule_tick_progress_window_result;
