...
void SetupGameLevel(void)
{
    ...
    CA_CacheMap(mapnum);
    mapon = mapnum - gamestate.episode * 10;
    ...
    fprintf(stderr, "[setup] mapnum=%d episode=%d gamestate.mapon=%d mapon=%d header=%ux%u\n",
            mapnum, gamestate.episode, gamestate.mapon, mapon, mapwidth, mapheight);
    fprintf(stderr, "[setup] mapname=%s\n", mapheaderseg[mapnum]->name);
...
void PlayDemo(int demonumber)
{
    ...
    NewGame(1, 0);
    fprintf(stderr, "[playdemo] demoptr0=%u,%u,%u,%u,%u,%u,%u\n",
            (unsigned char)demoptr[0], (unsigned char)demoptr[1], (unsigned char)demoptr[2],
            (unsigned char)demoptr[3], (unsigned char)demoptr[4], (unsigned char)demoptr[5], (unsigned char)demoptr[6]);
    mapId = *demoptr++;
    gamestate.mapon = mapId;
    gamestate.difficulty = gd_hard;
    length = (byte)demoptr[0] | ((unsigned)demoptr[1] << 8);
    demoptr += 3;
